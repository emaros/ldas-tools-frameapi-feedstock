...
pixi add ldas-tools-frameapi
# for installing globally
pixi global install ldas-tools-frameapi
```
...
It is possible to list all of the versions of `ldas-tools-frameapi` available on your platform:
...
```
pixi search ldas-tools-frameapi --channel conda-forge
```
